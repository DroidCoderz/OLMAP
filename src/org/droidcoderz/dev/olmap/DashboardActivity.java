...
public class DashboardActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        Button btn_mapdrawer = (Button) findViewById(R.id.btn_mapfilebrowser);
        ...
        btn_mapview.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent i = new Intent(getApplicationContext(), OLMAPActivity.class);
                startActivity(i);
            }
        });
...
//        });
        ...
        // Listening map file browser button click
//        btn_mapdrawer.setOnClickListener(new View.OnClickListener() {
//             
//            @Override
//            public void onClick(View view) {
//                // Launching mapdrawer Screen
//                Intent i = new Intent(getApplicationContext(), MapFileBrowserActivity.class);
//                startActivity(i);
//            }
//        });
