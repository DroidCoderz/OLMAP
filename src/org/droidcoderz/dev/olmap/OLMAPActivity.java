...
import org.droidcoderz.dev.olmap.maplisteners.MyLocationMapEventListener;

public class OLMAPActivity extends Activity {
...
//    NMLModel locationMarkerModel;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.olmap_mapview);
        Log.enableAll();
        Log.setTag("gpsmap");
